...
class salary extends Controller
{
    public function index()
    {
        ...
        $salary = employeesalaries::leftJoin('employees', 'employeesalaries.employeeId', '=', 'employees.id')
    ...
    public function edit_salary(Request $request, $id)
    {
        ...
        $employee_info = employees::leftJoin('designations', 'employees.designation', '=', 'designations.id')
                     ->select('employees.*','designations.desig_name')
                    ->get();
        $bank_info = banks::all();
