...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1 class="m-0">Edit Absent Payments</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="">Home</a></li>
        <li class="breadcrumb-item active">Edit Absent Payments</li>
      </ol>
    </div><!-- /.col -->
  </div><!-- /.row -->
</div><!-- /.container-fluid -->
    ...
    <div class="col-md-12 m-auto">
      ...
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Edit  Absent Payments </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
          ...
          <div class="d-flex">
                                <div class="form-group col-4">
                                    ...
                                    <select class="form-select form-control" id="emId" name="emId" required onchange="updateName()">
                                        ...
                                        <option value="{{ $employee->id }}" {{ $absent_payments_info->emId == $employee->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter name"  value='{{ $absent_payments_info->emId == $employee->employeeId ? $employee->name  : '' }}'>
                                </div>

                                <div class="form-group col-4">
                                    <label for="desig_name">Designation</label>
                                    <input type="text" class="form-control" id="desig_name" name="desig_name" placeholder="Enter desig_name"  value='{{ $absent_payments_info->emId == $employee->employeeId ? $employee->desig_name  : '' }}'>
            ...
            <div class="d-flex">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="month" class="form-control" id="adjust_month" name="adjust_month" placeholder="Enter adjust month" value="{{ $absent_payments_info->adjust_month }}">
                        <p id="adjust_monthError" class="text-danger"></p>
                    </div>
                    <div class="form-group col-4">
                        <label for="payment_days">payment Days</label>
                        <input type="number" class="form-control" id="payment_days" name="payment_days" placeholder="Enter payment days"  value="{{ $absent_payments_info->payment_days }}">
                        <p id="payment_daysError" class="text-danger"></p>
                    </div>

                      <div class="form-group col-4">
                        <label for="amount">Amount</label>
                        <input type="number" class="form-control" id="amount" name="amount" placeholder="Enter amount"  value="{{ $absent_payments_info->amount }}">
