@extends('layouts.app')  
    ...
    @section('content_header')
       <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 ">Employee Increment Report List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
              <li class="breadcrumb-item active">Employee Increment Report List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Employee Increment Report List</h3>
              </div>
              <div class="card-body">
              <form method="post" action="{{ route('employee_increment_report') }}" onsubmit="return validateForm()">
              @csrf
            <div class="d-flex">
            ...
            <div class="form-group col-2">
              ...
              <div class='d-flex'>
                  ...
                  <div class="form-group col-2">
                            ...
                            <input type="number" class="form-control" id="increment" name="increment" placeholder="Enter Increment Amount" value='{{ $incrementAmount }}'>
                            <!-- <p id="grossError" class="text-danger"></p> -->
                  </div>
               </div>
              ...
              <h6 class="fw-bold my-3">Employee Increment Report List</h6>
