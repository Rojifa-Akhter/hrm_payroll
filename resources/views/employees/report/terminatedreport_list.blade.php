@extends('layouts.app')  
    ...
    @section('content_header')
       <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 ">Terminated Employee Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="">Home</a></li>
              <li class="breadcrumb-item active">Terminated Employee Report List</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Terminated Employee Report List</h3>
              </div>
              <div class="card-body">
              <form method="post" action="{{ route('terminated_employee_report') }}" onsubmit="return validateForm()">
              @csrf
            <div class="d-flex">
            ...
            <div class="form-group col-2">
              ...
              <h6 class="fw-bold my-3">Terminated Employee Report</h6>
