        ...
        <form method="post" action="{{ route('designation_add_action') }}" onsubmit="return validateForm()">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" autocomplete="off" class="form-control @error('desig_name') is-invalid @enderror" id="desig_name" name="desig_name" placeholder="Designation Name" value="{{old('desig_name')}}">
            ...
            <div class="form-group">
              ...
              <input type="text" autocomplete="off" class="form-control" id="desig_description" name="desig_description" placeholder="Enter Designation Description" value="{{old('desig_description')}}">
              <p id="desig_descriptionError" class="text-danger"></p>
              @error('desig_description')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{$message}}</strong>
                  </span>
              @enderror
            ...
            <div class="form-group">
              ...
              <input type="text" autocomplete="off" class="form-control" id="desig_short_name" name="desig_short_name" placeholder="Enter Designation Short Name" value="{{old('desig_short_name')}}">
            ...
            <div class="form-group">
              ...
              <input type="text" autocomplete="off" class="form-control" id="desig_rank" name="desig_rank" placeholder="Enter Designation Rank Numaric value" value="{{old('desig_rank')}}">
