        ...
        <form method="post" action="{{ route('update_designation') }}" onsubmit="return validateForm()">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" autocomplete="off" class="form-control" id="desig_name" name="desig_name" placeholder="Designation Name" value="{{ $designation_info->desig_name }}">
              <p id="desig_nameError" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="desig_description">Designation Description</label>
              <input type="text" autocomplete="off" class="form-control" id="desig_description" name="desig_description" placeholder="Enter Designation Description" value="{{ $designation_info->desig_description }}">
              <p id="desig_descriptionError" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="desig_short_name">Designation Short Name</label>
              <input type="text" autocomplete="off" class="form-control" id="desig_short_name" name="desig_short_name" placeholder="Enter Designation Short Name" value="{{ $designation_info->desig_short_name }}">
              <p id="desig_short_nameError" class="text-danger"></p>
            </div>
            <div class="form-group">
              <label for="desig_rank">Designation Rank</label>
              <input type="text" autocomplete="off" class="form-control" id="desig_rank" name="desig_rank" placeholder="Enter Designation Rank" value="{{ $designation_info->desig_rank }}">
