            ...
            <div class="card-body p-0">
              <div class="bs-stepper1">
                ...
                <div class="bs-stepper-content">
                  ...
                  <form method="post" action="{{ route('update.personal') }}" id="employeeForm" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fullName" name="full_name" value="{{ $employee->name }}">
                          </div>
                          <div class="form-group">
                            <label for="name">Father Name</label>
                            <input type="text" class="form-control" id="fatherName " name="father_name" value="{{ $employee->fatherName }}" placeholder="Enter Father Name">
                          </div>
                          <div class="form-group">
                            <label for="name">Mother Name</label>
                            <input type="text" class="form-control" id="motherName" name="mother_name" value="{{ $employee->motherName }}" placeholder="Enter Mother Name">
                          </div>
                          <div class="form-group">
                            <label for="name">Birth Date<span>*</span></label>

                            <input class="form-control @error('birth_date') is-invalid @enderror" type="date" name="birth_date" id="birth_date" value="{{ $employee->dob }}" />
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="nationality" id="nationality">
                              ...
                              <option <?php if ($employee->nationality == "Bangladesh") echo 'selected'; ?> value="Bangladesh">Bangladesh</option>
                              <option <?php if ($employee->nationality == "Indian") echo 'selected'; ?> value="Indian">Indian</option>
                            </select>
                          </div>
                          <div class="form-group">
